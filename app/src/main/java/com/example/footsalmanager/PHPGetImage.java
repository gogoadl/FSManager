...
public class PHPGetImage extends PHPRequest {
    @Override
        protected String doInBackground(String... params) // String... params = 파라미터로 String형을 제한없이 받는다. 여러개의 파라미터를 받을 수 있게 하는거
        {
            ...
            try {
                String NickNameString = params[0];
                String ImageString = params[1];

                String data = URLEncoder.encode("NickName", "UTF-8") + "=" + URLEncoder.encode(NickNameString, "UTF-8");
